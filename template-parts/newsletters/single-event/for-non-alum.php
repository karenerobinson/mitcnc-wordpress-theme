                            ...
                            <table border="0" width="100%" cellspacing="0" cellpadding="10">
                                ...
                                <tr>
                                    ...
                                    if (!empty($event->post_content)) {
                                        echo filter_var(wpautop($event->post_content), FILTER_UNSAFE_RAW);
                                    }
                                    ?>
                                    </td>
                            ...
                            <?php if (!empty($non_mit_registration['link'])) { ?>
                                <td width="50%">
                                    <table width="100%" cellpadding="2" cellspacing="0">
                                        <tr>
                                            <td align="center" valign="bottom" style="padding:15px 0 0 0 ; color: black; font-size: 20px; font-weight: bold; font-family:Helvetica, Arial, sans-serif;background-color: #fff;">General Admission</td>
                                        </tr>
                                        <tr>
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        if (is_array($non_mit_registration['details']) && $non_mit_registration['details'] != null) {
                                                                ...
                                                                if ($details['description'] != null) {
                                                                    ...
                                                                    foreach ($details['description'] as $description) {
                                                                        if (
                                                                            ...
                                                                            ?>
                                                                <td align="center" style="color: #A31F34;font-size: 14px;font-family:Helvetica, Arial, sans-serif;">
                                                                    <br><span style="font-size: 30px; color: #A31F34; font-weight: bold;"><?php echo !empty($description['price']) ? esc_html($description['price']) : '&nbsp;'; ?></span><br><br>
                                                            ...
                                                            ?>
                                                            <td align="center" style="color: #f5f5f5;font-size: 14px;font-family:Helvetica, Arial, sans-serif;">
