                                                    ...
                                                    if (
                                                        ...
                                                        <p style="font-family:Helvetica, Arial, sans-serif; font-size: 15px; color: #555; padding-top:10px; line-height: 150%;">
                                                            <strong> Contacts  </strong><br>
                                                                    <?php echo (!empty($event_primary_contact['name'])) ? '<strong style=" font-size: 12px; color: #5b5b5b;">' . esc_html($event_primary_contact['name']) . '</strong><br>' : ''; ?>
                                                                    <?php echo (!empty($event_primary_contact['email'])) ? '<a href="mailto:' . esc_html($event_primary_contact['email']) . '" style="font-size: 15px;  color: #81a6fb;  line-height: 150%; text-decoration: none; font-weight:400;">' . esc_html($event_primary_contact['email']) . '</a>' : ''; ?>
                                                        </p>
                                                                    <?php
                                                    }
                                                    ?>
                            ...
                            <?php if (!empty($mit_registration['link'])) { ?>
                                <td width="50%">
                                    <table width="100%" cellpadding="2" cellspacing="0">
                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        if (is_array($mit_registration['details']) && $mit_registration['details'] != null) {
                                                                ...
                                                                if ($details['description'] != null) {
                                                                    ...
                                                                    foreach ($details['description'] as $description) {
                                                                        if (
                                                                            ...
                                                                            ?>
                                                                            <td align="center" style="color: #fff;font-size: 14px;font-family:Helvetica, Arial, sans-serif;">
                                                                                <br><span style="font-size: 30px; font-weight: bold;color:#A31F34;"><?php echo !empty($description['price']) ? esc_html($description['price']) : '&nbsp;'; ?></span><br><br>
                                                                                <span style="color: black;"><?php echo !empty($details['title']) ? esc_html($details['title']) : 'MITCNC Member'; ?></span><br><br>
                                                                            </td>
                                                                            <?php
                                                                            break;
                                                                        }
                                                            ...
                                                            ?>
                                                            <td align="center" style="color: #fff;font-size: 14px;font-family:Helvetica, Arial, sans-serif;">
                                                                <br><span style="font-size: 30px; font-weight: bold;">&nbsp;</span><br><br>
                                                                &nbsp;<br>
                                                            </td>
                                                            <?php
                                                        }
                                        ...
                                        <tr>
                                            <td align="center" style="background-color: #ffff; padding: 10px 20px;">
                                                <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                                    <tbody>
                                                    <tr>
                                                        <td style="background-color: #30b630; text-align: center; border-radius: 2px; padding: 10px 30px; display: block;">
                                                            <a style="color: #ffff; font-family:Helvetica, Arial, sans-serif; text-decoration: none;" href="<?php echo esc_url($mit_registration['link']); ?>" target="_blank">Reserve Now</a>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <tr>
                                                        <td style="padding-bottom: 14px;">
                                                            <a href="<?php echo esc_url(get_permalink($upcoming_event)); ?>">
                                                                <img style="border-radius: 4px;" src="<?php echo esc_url($image); ?>" width="600" />
                                                            </a>
                                                        </td>
                                                    </tr>
                                                <?php
                ...
                <table border="0" width="100%" cellspacing="0" cellpadding="0" style="font-family:Helvetica, Arial, sans-serif; color: #adadb9;">
                    ...
                    <tr>
                        <td>
                            ...
                            <p style="font-size: 14px;"><a style="color: #adadb9; text-decoration: none" href="https://alum.mit.edu/about/privacy-statement">Privacy Policy</a> | <a style="color: #adadb9; text-decoration: none" href="##Unsubscribe_URL##">##Unsubscribe##</a></p>
                        </td>
                        <td align="left" valign="top">
