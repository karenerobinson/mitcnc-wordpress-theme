                            ...
                            <tr>
                                <td style="padding: 10px;" align="right">
                                    <span style="font-weight: bold; font-family: Helvetica, Arial, sans-serif; font-size: 16px; color: <?php echo esc_attr($newsletter_display_mode['font_color']); ?>;">
                                        <?php echo esc_html((isset($auth_name[0])) ? $auth_name[0] : ''); ?>
                                        <?php
                                ...
                                <td>
                                    <table border="0" width="100%" cellspacing="0" cellpadding="10">
                                        ...
                                        <tr>
                                            ...
                                            <td style="color: <?php echo esc_attr($newsletter_display_mode['featured_event_date_color']); ?>; font-family: Helvetica, Arial, sans-serif;">
                                                <?php
        ...
        <?php if ($member_event != null) { ?>
            <tr>
                <td style="background-color: #fff; padding: 20px; border-radius: 4px; box-shadow: 1px 1px 1px #ccc;">
                    <span style="padding: 30px 0 16px; font-family: Helvetica, Arial, sans-serif; font-size: 24px; color: <?php echo esc_attr($newsletter_display_mode['font_color']); ?>;">Members Only Events & Save The Date</span><br><br>
                    <table style="font-family: Helvetica, Arial, sans-serif; padding-top: 20px;" border="0" width="100%" cellspacing="0" cellpadding="0">
                        ...
                        foreach ($member_event as $members) {
                            ...
                            ?>
                            <tr>
                                <td style="border-bottom: 1px dotted #adadb9; font-size: 20px; text-align: center; background-color: #ebebf1; color: <?php echo esc_attr($newsletter_display_mode['font_color']); ?>; font-weight: bold; padding: 6px 10px;" align="center">
            ...
            <td style="background-color: <?php echo esc_attr($newsletter_display_mode['gray_bg']); ?>; padding: 20px; border-radius: 4px; box-shadow: 1px 1px 1px #ccc;">
                ...
                <table style="background-color:<?php echo esc_attr($newsletter_display_mode['light_gray_bg']); ?>; text-align: center; border-radius: 2px; font-family: Helvetica, Arial, sans-serif;" border="0" width="100%" cellspacing="20" cellpadding="20">
                    ...
                    <tr>
                        ...
                        <a style="color: #fff; font-family: Helvetica, Arial, sans-serif; text-decoration: none; font-size: 18px; font-weight: bold;" href="<?php echo esc_url(get_membership_url()); ?>#membership-status">
