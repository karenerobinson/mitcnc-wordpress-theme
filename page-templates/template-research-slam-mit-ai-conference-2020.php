<?php
    /* Template Name: Research Slam MIT AI Conference 2020 */
    get_header();
    global $assets_uri, $event_category_taxonomy, $event_location_taxonomy, $user_profile_page_id, $specific_event;
    $post = get_post(4604);
if (isset($post->ID)) {
    $meta_data = get_post_meta($post->ID);
    $banner = get_the_post_thumbnail_url(6205, 'thumbnail_1079_474');
                        ...
                        <div class="row">
                            <div class="col-lg-18 col-md-16 col-sm-24 yearly-events top-btn" >
                                <ul>
                                    ...
                                    <li >
                                        <a href="https://www.mitcnc.org/events/mit-ai-conference-2020/#speakers">Speakers</a>
                                    </li>
                                    <li>
                    ...
                    <div class="container" id="ai-idol-2020">
                            ...
                            <div class="col-sm-7 offset-sm-2">
                                <div class="event-reserve">
                                    ...
                                    <p>
                                        ...
                                        Sat, Jul 18, 2020<br>
                                        12:00 - 1:00 PM  PT<br>
                                        <a target="_blank" href="<?php echo esc_attr(site_url()); ?>/add-to-calendar/?event_id=5108" class="">
                                    ...
                                    <p>
                                        ...
                                        Alumni Education<br><a href="mailto:alumnilearn@mit.edu">alumnilearn@mit.edu</a>                                                  
                                    </p>
                                    ...
                                    ?>
                            <div class="row mt70" id="event-info">
                                <div class="col-sm-12 mb-5">
                                    <div class="white-boxes">
                                        <h2 class="blue">The Rules:</h2>
                                            <ul>
                                                <li>Present your research in <strong class="blue-text">four minutes or less</strong>. Teach us—be creative and compelling!</li>
                                                <li>One slide (use limited animation, if any)</li>
                                                <li>Present your own research</li>
                                                <li>Be prepared to answer one question from the audience after your pitch</li>
                                            </ul>
                                    </div>
                                </div>
                                <div class="col-sm-12 mb-5">
                                    <div class="white-boxes">
                                        <h2 class="blue">Judges will evaluate pitches using the following criteria. Did the competitor:</h2>
                                            <ul>
                                                <li>Make effective use of time?</li>
                                                <li>Explain the topic in terms understandable to everyone?</li>
                                                <li>Speak clearly / speak at an appropriate pace?</li>
                                                <li>Capture your attention from the beginning of the presentation and hold it?</li>
                                                <li>Motivate/ advance/ propose viable solution(s) to the problem / question / goal?</li>
                                                <li>Convince you of the importance of their research?</li>
                                                <li>Create an effective visual that supported the pitch?</li>
                                            </ul>
                                    </div>
                                </div>
                                <div class="col-sm-12 mb-5">
                                    <div class="white-boxes">
                                        <h2 class="blue">Tips:</h2>
                                            <ul>
                                                <li>Please keep in mind that you will be judged on your ability to clearly pitch your research to thejudges and audience (not the actual research itself).</li>
                                                <li>Practice, practice, practice! We will end your pitch at the 3-minute mark if you are stillpresenting.</li>
                                                <li>Don’t try to fit too much information on your slide. Less is often more.</li>
                                                <li>Remember that your audience might not be experts on your topic. Present in terms everyone can understand.</li>
                                                <li>Be aware of your body language, movement, hand gesture etc.</li>
                                                <li>Smile! Have fun!</li>
                                            </ul>
                                    </div>
                                </div>
                                <div class="col-sm-12 mb-5">
                                    <div class="white-boxes">
                                        <h2 class="blue">Prizes:</h2>
                                            <ul>
                                                <li>1st Place: $1,000 gift to MIT COVID-19 research made in competitor’s name</li>
                                                <li>2nd Place: $500 gift to MIT COVID-19 research made in competitor’s name</li>
                                                <li>3rd Place: $250 gift to MIT COVID-19 research made in competitor’s name</li>
                                            </ul>
                                    </div>
                                </div>
                            </div>
                        <div class="row ">
                            ...
                            <div class="col-sm-24 col-md-12 col-lg-8 col-xl-6">
                                <div class="speaker-card" style="padding:33px !important;">
                                    <div class="card-img">
                                        <img src="https://www.mitcnc.org/app/media/2019/02/Rima-Arnaout.png">
                                        <div class="icon-mit">
                            ...
                            <div class="col-sm-24 col-md-12 col-lg-8 col-xl-6">
                                <div class="speaker-card" style="padding:33px !important;">
                                    <div class="card-img">
                                        <img src="https://www.mitcnc.org/app/media/2020/07/Bob-Prior.png">
                                        <div class="icon-mit">
                                            <img src="<?php echo esc_url($assets_uri); ?>/images/mit-icon.svg" alt="">
                                        </div>                                      
                                    </div>
                            ...
                            <div class="col-sm-24 col-md-12 col-lg-8 col-xl-6">
                                <div class="speaker-card" style="padding:33px !important;">
                                    <div class="card-img">
                                        <img src="https://www.mitcnc.org/app/media/2020/07/Yu-She.png">
                                        <div class="icon-mit">
                                            <img src="<?php echo esc_url($assets_uri); ?>/images/mit-icon.svg" alt="">
                                        </div>
                                    </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-24 col-md-12 col-lg-8 col-xl-6">
                                <div class="speaker-card" style="padding:33px !important;">
                                    <div class="card-img">
                                        <img src="https://www.mitcnc.org/app/media/2020/07/arun-saigal-1.png">
                                        <div class="icon-mit">
                                            <img src="<?php echo esc_url($assets_uri); ?>/images/mit-icon.svg" alt="">
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-24 col-md-12 col-lg-8 col-xl-6">
                                <div class="speaker-card" style="padding:33px !important;">
                                    <div class="card-img">
                                        <img src="https://www.mitcnc.org/app/media/2020/07/dummy.png">
                                        <div class="icon-mit">
                                            <img src="<?php echo esc_url($assets_uri); ?>/images/mit-icon.svg" alt="">
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-24 col-md-12 col-lg-8 col-xl-6">
                                <div class="speaker-card" style="padding:33px !important;">
                                    <div class="card-img">
                                        <img src="https://www.mitcnc.org/app/media/2020/07/Ari-Daniel.png">
                                        <div class="icon-mit">
                                            <img src="<?php echo esc_url($assets_uri); ?>/images/mit-icon.svg" alt="">
                                        </div>      
                                    </div>
                                    <div class="card-text">
                                        <div class="name">
                                            <h3>Thanard Kurutach</h3>
                                        </div>
                                        <div class="company-name ">
                                            <span>Berkeley AI Research (BAIR) at UC Berkeley</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-24 col-md-12 col-lg-8 col-xl-6">
                                <div class="speaker-card" style="padding:33px !important;">
                                    <div class="card-img">
                                        <img src="https://www.mitcnc.org/app/media/2020/07/Ari-Daniel-1.png">
                                        <div class="icon-mit">
                                            <img src="<?php echo esc_url($assets_uri); ?>/images/mit-icon.svg" alt="">
                                        </div>
                                    </div>
                        ...
                        <div class="row ">
                            <div class="col-sm-24">
                                <h2 class="blue">Past Judges</h2>
                            </div>  
                            <div class="col-sm-24 col-md-12 col-lg-8 col-xl-6">
                                <div class="speaker-card" style="padding:33px !important;">
                                    <div class="card-img">
                                        <img src="https://www.mitcnc.org/app/media/2020/06/Ari-Daniel.png">
                                        <div class="icon-mit">
                                            <img src="<?php echo esc_url($assets_uri); ?>/images/mit-icon.svg" alt="">
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-24 col-md-12 col-lg-8 col-xl-6">
                                <div class="speaker-card" style="padding:33px !important;">
                                    <div class="card-img">
                                        <img src="https://www.mitcnc.org/app/media/2020/06/Bob-Prior.png">
                                        <div class="icon-mit">
                                            <img src="<?php echo esc_url($assets_uri); ?>/images/mit-icon.svg" alt="">
                                        </div>
                                    </div>
                                    <div class="card-text">
                                        <div class="name">
                                            <h3>Bob Prior</h3>
                                            <span class="code">MIT Press</span>
                                        </div>
                                        <div class="company-name ">
                            ...
                            <div class="col-sm-24 col-md-12 col-lg-8 col-xl-6">
                                <div class="speaker-card" style="padding:33px !important;">
                                    <div class="card-img">
                                        <img src="https://www.mitcnc.org/app/media/2020/06/Vivian-Siegel.png">
                                        <div class="icon-mit">
                                            <img src="<?php echo esc_url($assets_uri); ?>/images/mit-icon.svg" alt="">
                                        </div>
                                    </div>
                                    <div class="card-text">
                                        <div class="name">
                                            <h3>Vivian Siegel</h3>
                                            <span class="code">MIT Department of Biology</span>
                                        </div>
                                        <div class="company-name ">
                                            <span>Lecturer</span>
                                        </div>
                            ...
                            <div class="col-sm-24 col-md-12 col-lg-8 col-xl-6">
                                <div class="speaker-card" style="padding:33px !important;">
                                    <div class="card-img">
                                        <img src="https://www.mitcnc.org/app/media/2020/06/Holden-Thorp.png">
                                        <!-- <div class="icon-mit">
                                            <img src="<?php echo esc_url($assets_uri); ?>/images/mit-icon.svg" alt="">
                                        </div> -->
                                    </div>
                            ...
                            <div class="col-sm-24">
                                <p>All competitors will be publicized to all alumni registrants, and winners’ names will be posted on the MIT Alumni Association website and spotlighted on social media.</p>
