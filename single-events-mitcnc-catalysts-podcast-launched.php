                ...
                <div class="container event-banner-container">
                    <div class="row">
                        ...
                        <div class="col-sm-24 evb-col">
                            <div class="event-banner custom-event-banner <?php echo !empty($banner) ? '' : 'no-img'; ?>"
                                        ...
                                        <div class="event-reg-btn">
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <?php if(isset($meta_data['registration_3_affiliate_reservation_link']) && count($meta_data['registration_3_affiliate_reservation_link']) > 0 && !empty($meta_data['registration_3_affiliate_reservation_link'][0])): ?>
                                                    <a href="<?php echo $meta_data['registration_3_affiliate_reservation_link'][0]; ?>"  target="_blank" class="default-btn">Reserve Now<img
                                                            src="<?php echo $assets_uri; ?>/images/arrow_right_white.svg"
                                                            alt=""></a>
                                                <?php else: ?>
                ...
                <div class="container">
                        ...
                        <div class="col-sm-7 offset-sm-2">
                            <div class="event-reserve">
                                ...
                                <?php } else { ?>
                                    ...
                                    <?php if(isset($meta_data['registration_3_affiliate_reservation_link']) && count($meta_data['registration_3_affiliate_reservation_link']) > 0 && !empty($meta_data['registration_3_affiliate_reservation_link'][0])): ?>
                                        <a href="<?php echo $meta_data['registration_3_affiliate_reservation_link'][0]; ?>" class="default-btn mb20">Reserve Now<img
                                                src="<?php echo $assets_uri; ?>/images/arrow_right_white.svg"
                                                alt=""></a>
                                    <?php else: ?>
                                ...
                                <?php if (isset($meta_data['agenda'][0]) && $meta_data['agenda'][0] > 0) { ?>
                                    <p>
                                        ...
                                        <b><?php echo $meta_data['agenda_' . $i . '_agenda_title'][0]; ?></b>
                                                <?php echo '<br>'; ?>
                                ...
                                <p>
                                    ...
                                    <?php echo !empty($event_address) ? '<b>'.$event_address.'</b><br>' : '' ?>
                    ...
                    <div class="row">
                        <div class="col-sm-24 mt20">
                               <a href="https://www.buzzsprout.com/615046/1788097-kyle-vogt"> <img src="https://www.mitcnc.org/app/media/2019/10/Cruise-Link-Banner.png" width="100%"></a>
                        </div>
                    </div>
                    <?php
                    if (
